...
class SquashCourtBookingDetails extends StatefulWidget {
  final data;
  ...
  @override
  _SquashCourtBookingDetails createState() => _SquashCourtBookingDetails();
}

class _SquashCourtBookingDetails extends State<SquashCourtBookingDetails> {
