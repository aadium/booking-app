...
import 'package:booking_app/pages/admin/bookings/tennis_court/booking_details.dart';
...
class AdminViewTennisCourtBookings extends StatefulWidget {
  final DateTime selected_date;

  const AdminViewTennisCourtBookings({super.key, required this.selected_date});

  @override
  _AdminViewTennisCourtBookingsState createState() => _AdminViewTennisCourtBookingsState();
}

class _AdminViewTennisCourtBookingsState extends State<AdminViewTennisCourtBookings> {
                          ...
                          child: TertiaryButton(
                            onPressed: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        AdminTennisCourtBookingDetails(
                                          data: data,
